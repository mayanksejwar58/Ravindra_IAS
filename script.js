...
const pdfCategories = {
  all: {
    title: "📥 Free Downloads — All Resources", pdfs: [
  ...
  ca: {
    title: "📰 Current Affairs — March 2026", pdfs: [
  ...
  pyq: {
    title: "📋 Previous Year Question Papers", pdfs: [
  ...
  mindmaps: {
    title: "🗺️ GS Mind Maps Library", pdfs: [
  ...
  ncert: {
    title: "📚 NCERT Books for UPSC", pdfs: [
  ...
  ethics: {
    title: "⚖️ Ethics & GS Paper IV Resources", pdfs: [
  ...
  yojana: {
    title: "🏛️ Government Magazines Archive", pdfs: [
  ...
  prs: {
    title: "📜 Bills, Acts & Legislative Research", pdfs: [
      { id: 'prs', name: "PRS Legislative Research Capsule 2025", cat: "Bills & Acts", size: "2.1 MB", pages: 64, icon: "📜" },
  ...
  infographics: {
    title: "📊 GS Infographics Library", pdfs: [
